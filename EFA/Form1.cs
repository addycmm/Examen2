...
namespace EFA
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            pictureBox2.SizeMode = PictureBoxSizeMode.Zoom; // Ajustar la imagen al tamaño del PictureBox
            pictureBox2.MouseClick += PictureBox2_MouseClick; // Agregar evento de clic
        }
        ...
        {
            string cadenaConexion = "server=localhost;database=colora;uid=root;pwd=;";
        ...
        private void CargarColoresDesdeBD()
        {
            ...
            {
                conexion.Open();
                string consulta = "SELECT colorinicial, colorfinal FROM colores";
                MySqlCommand comando = new MySqlCommand(consulta, conexion);
                MySqlDataReader lector = comando.ExecuteReader();
                while (lector.Read())
                {
                    string colorOriginalString = lector["colorinicial"].ToString();
                    string colorCambioString = lector["colorfinal"].ToString();
        ...
        private void CargarDatosEnDataGridView()
        {
            ...
            try
            {
                ...
                MySqlDataAdapter adaptadorDatos = new MySqlDataAdapter(consulta, conexion);
        ...
        private void PictureBox2_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (punto.X < 0 || punto.Y < 0 || punto.X >= imagenModificada.Width || punto.Y >= imagenModificada.Height)
                return;
